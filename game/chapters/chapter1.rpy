...
show k look_eyes at step_left(0):
...
think
K "Стоп. Мне же нужна эта работа."4
point
K "О, а вот и нужная дверь!"
#стучит в дверь

show k shy at jumping(2)
K "Кхм-кхм, пардоньте."
...
show f table_panic at jumping(4)
F "ЭЙ!"
show f table_panic at panic_run(2)
F_m "Где же шляпа?" #не знаю, как помечать мысли, может маленькой "м"?
show f table_panic at face_right
